document.addEventListener("DOMContentLoaded", () => {
    ...
    const resetSortSaleDateButton = document.getElementById("reset-sort");
    ...
    function displayTotalRevenue(data) {
        ...
        if (totalRevenueElement) {
            ...
            let formattedTotalRevenue = totalRevenue.toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 2, maximumFractionDigits: 2 });
